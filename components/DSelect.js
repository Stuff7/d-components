import "../style.css";
import { defineComponent as p, ref as b, openBlock as n, createElementBlock as d, normalizeClass as r, unref as s, Fragment as S, renderList as V, normalizeStyle as D, toDisplayString as f, createCommentVNode as $, createElementVNode as K, renderSlot as _, createTextVNode as h, createVNode as C } from "vue";
import k from "./DIcon.js";
import { isIndexable as B } from "../utils.js";
import { _ as N } from "../_plugin-vue_export-helper-dad06003.js";
const z = ["value", "disabled"], E = ["value", "selected"], L = /* @__PURE__ */ p({
  __name: "DSelect",
  props: {
    options: {},
  ...
  setup(m, { emit: y }) {
    ...
    const o = c.bind(a.valueKey), i = c.bind(a.labelKey), g = (e) => {
...
}), M = "_DSelect_gyvpa_1", F = "_toggle_gyvpa_5", I = "_nativeSelect_gyvpa_21", T = {
  DSelect: M,
  toggle: F,
  nativeSelect: I
}, j = {
